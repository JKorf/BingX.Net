...
namespace BingX.Net.Interfaces.Clients.SpotApi
{
    ...
    public interface IBingXRestClientSpotApiTrading
    {
        ...
        /// <param name="price">["<c>price</c>"] Order price for limit orders</param>
        /// <param name="quoteQuantity">["<c>quoteOrderQty</c>"] Order quantity in quote asset</param>
        ...
        /// </para>
        /// </summary>
        /// <param name="orders">["<c>data</c>"] Orders to place</param>
        ...
        /// </summary>
        /// <param name="symbol">["<c>symbol</c>"] Symbol, for example `ETH-USDT`</param>
        /// <param name="orderIds">["<c>orderIds</c>"] The order ids to cancel</param>
        /// <param name="clientOrderIds">["<c>clientOrderIDs</c>"] The client order ids to cancel</param>
        ...
        /// <param name="limitPrice">["<c>limitPrice</c>"] Limit order price</param>
        /// <param name="orderPrice">["<c>orderPrice</c>"] The limit order price set after a stop-limit order is triggered</param>
        /// <param name="triggerPrice">["<c>triggerPrice</c>"] The trigger price of the stop limit order</param>
        /// <param name="clientOrderId">["<c>listClientOrderId</c>"] Client order id</param>
