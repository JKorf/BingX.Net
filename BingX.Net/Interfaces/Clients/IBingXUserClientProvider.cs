...
namespace BingX.Net.Interfaces.Clients
{
    ...
    /// </summary>
    public interface IBingXUserClientProvider : IExchangeService
    {
        /// <summary>
        ...
        void InitializeUserClient(string userIdentifier, BingXCredentials credentials, BingXEnvironment? environment = null);
        ...
        /// <param name="environment">The environment to use</param>
        IBingXRestClient GetRestClient(string userIdentifier, BingXCredentials? credentials = null, BingXEnvironment? environment = null);
        ...
        /// <param name="credentials">The credentials for the user. Required the first time a client is requested for this user unless <see cref="InitializeUserClient" /> has been called prior for this user.</param>
        /// <param name="environment">The environment to use</param>
        IBingXSocketClient GetSocketClient(string userIdentifier, BingXCredentials? credentials = null, BingXEnvironment? environment = null);
    }
}