...
namespace BingX.Net.UnitTests
{
    ...
    internal class SharedRestIntegrationTests
    {
        ...
        private IBingXRestClientSpotApiShared GetSpotRestClient()
        {
            var collection = new ServiceCollection();
            collection.AddBingX(x => x.Rest.OutputOriginalData = true);
            ...
            return sp.GetRequiredService<IBingXRestClient>().SpotApi.SharedClient;
        }

        private IBingXRestClientPerpetualFuturesApiShared GetFuturesRestClient()
        {
            var collection = new ServiceCollection();
            collection.AddBingX(x => x.Rest.OutputOriginalData = true);
            collection.AddLogging(x =>
            ...
            var sp = collection.BuildServiceProvider();
            return sp.GetRequiredService<IBingXRestClient>().PerpetualFuturesApi.SharedClient;
        }
