...
namespace BingX.Net.UnitTests.TestImplementations
{
    public class TestHelpers
    {
        ...
        public static IBingXSocketClient CreateSocketClient(IWebsocket socket, Action<BingXSocketOptions> options = null)
        {
        ...
        public static IBingXRestClient CreateClient(Action<BingXRestOptions> options = null)
        {
        ...
        public static IBingXRestClient CreateResponseClient(string response, Action<BingXRestOptions> options = null)
        {
            var client = (BingXRestClient)CreateClient(options);
            SetResponse(client, response);
            return client;
        }

        public static IBingXRestClient CreateResponseClient<T>(T response, Action<BingXRestOptions> options = null)
        {
            var client = (BingXRestClient)CreateClient(options);
        ...
        public static void SetResponse(BingXRestClient client, string responseData)
        {
        ...
        public static void SetErrorWithResponse(IBingXRestClient client, string responseData, HttpStatusCode code)
        {
            var expectedBytes = Encoding.UTF8.GetBytes(responseData);
            var responseStream = new MemoryStream();
            responseStream.Write(expectedBytes, 0, expectedBytes.Length);
