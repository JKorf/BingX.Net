...
namespace BingX.Net.UnitTests
{
    ...
    public class SocketSubscriptionTests
    {
        ...
        public async Task ValidatePerpetualFutureSubscriptions()
        {
            ...
            await tester.ValidateAsync<IEnumerable<BingXFuturesTradeUpdate>>((client, handler) => client.PerpetualFuturesApi.SubscribeToTradeUpdatesAsync("ETH-USDT", handler), "Trades", nestedJsonProperty: "data");
            ...
            await tester.ValidateAsync<IEnumerable<BingXFuturesKlineUpdate>>((client, handler) => client.PerpetualFuturesApi.SubscribeToKlineUpdatesAsync("ETH-USDT", Enums.KlineInterval.OneMinute, handler), "Klines", nestedJsonProperty: "data");
