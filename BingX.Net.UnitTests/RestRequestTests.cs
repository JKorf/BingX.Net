...
namespace BingX.Net.UnitTests
{
    ...
    public class RestRequestTests
    {
        ...
        public async Task ValidatePerpetualFuturesTradingCalls()
        {
            ...
            await tester.ValidateAsync(client => client.PerpetualFuturesApi.Trading.GetOrderAsync("ETHUSDT", 1), "GetOrder", "data.order", ignoreProperties: new List<string> { "workingType", "advanceAttr", "takeProfitEntrustPrice", "stopLossEntrustPrice", "orderType" });
            await tester.ValidateAsync(client => client.PerpetualFuturesApi.Trading.CancelOrderAsync("ETHUSDT", 1), "CancelOrder", "data.order", ignoreProperties: new List<string> { "workingType", "advanceAttr", "takeProfitEntrustPrice", "stopLossEntrustPrice", "orderType" });
            await tester.ValidateAsync(client => client.PerpetualFuturesApi.Trading.CloseAllPositionsAsync("ETHUSDT"), "CloseAllPositions");
            await tester.ValidateAsync(client => client.PerpetualFuturesApi.Trading.CancelMultipleOrderAsync("ETHUSDT", new[] { 1L }), "CancelMultipleOrder", ignoreProperties: new List<string> { "workingType", "advanceAttr", "takeProfitEntrustPrice", "stopLossEntrustPrice", "orderType" });
            await tester.ValidateAsync(client => client.PerpetualFuturesApi.Trading.CancelAllOrderAsync("ETHUSDT"), "CancelAllOrder", ignoreProperties: new List<string> { "workingType", "advanceAttr", "takeProfitEntrustPrice", "stopLossEntrustPrice", "orderType" });
            await tester.ValidateAsync(client => client.PerpetualFuturesApi.Trading.GetOpenOrdersAsync("ETHUSDT"), "GetOpenOrders", "data.orders", ignoreProperties: new List<string> { "workingType", "advanceAttr", "takeProfitEntrustPrice", "stopLossEntrustPrice", "orderType" });
            await tester.ValidateAsync(client => client.PerpetualFuturesApi.Trading.GetLiquidationOrdersAsync("ETHUSDT"), "GetLiquidationOrders", "data.orders", ignoreProperties: new List<string> { "workingType", "advanceAttr", "takeProfitEntrustPrice", "stopLossEntrustPrice", "orderType" });
            await tester.ValidateAsync(client => client.PerpetualFuturesApi.Trading.GetClosedOrdersAsync("ETHUSDT"), "GetClosedOrders", "data.orders", ignoreProperties: new List<string> { "workingType", "advanceAttr", "takeProfitEntrustPrice", "stopLossEntrustPrice", "orderType", "type" });
            ...
            await tester.ValidateAsync(client => client.PerpetualFuturesApi.Trading.GetOrdersAsync("123", 123), "GetOrders", nestedJsonProperty: "data.orders", ignoreProperties: new List<string> { "workingType", "advanceAttr", "takeProfitEntrustPrice", "stopLossEntrustPrice", "orderType" });
